...
def main() -> None:
    ...
    mod.write_text(
        f'"""Generated by scripts/make_fast_policy.py from robot/{src} -- do not edit.\n\n'
        ...
        f"Max duty error vs the float reference of robot/{src} over 3000\n"
    ...
    bench_name = ("_bench_fast_linear.py" if "--linear" in sys.argv
                  else "_bench_fast.py")
    out = ROOT / "experimental" / "inference" / bench_name
    out.parent.mkdir(parents=True, exist_ok=True)
    parts = [f'"""Generated by scripts/make_fast_policy.py from robot/{src} -- do not edit."""',
