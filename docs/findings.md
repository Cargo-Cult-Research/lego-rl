# Findings — the long-form story

The lab book (`data/run_NN_*/`, rendered by `scripts/build_page.py`) is the
source of truth; this file is the connected narrative, moved out of the README
so the front page stays readable. Sections carry the date they were last
verified against the runs.
